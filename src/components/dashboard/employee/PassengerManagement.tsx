                ...
                <tr key={passenger.pid}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                      passenger.loyalty_status === 'PLATINUM' ? 'bg-purple-100 text-purple-800' :
                      passenger.loyalty_status === 'GOLD' ? 'bg-yellow-100 text-yellow-800' :
                      passenger.loyalty_status === 'SILVER' ? 'bg-gray-100 text-gray-800' :
        ...
        {selectedPassenger && (
          <form onSubmit={(e) => {
            ...
            handleUpdatePassenger({
              ...
              loyalty_status: (e.currentTarget.elements.namedItem('loyalty_status') as HTMLSelectElement).value,
              loyalty_points: parseInt((e.currentTarget.elements.namedItem('loyalty_points') as HTMLInputElement).value)
            });
          }}>
            <div className="space-y-4">
              <FormField
                label={t('name')}
                name="name"
                defaultValue={selectedPassenger.name}
              />
              <FormField
                label={t('loyaltyStatus')}
                name="loyalty_status"
                type="select"
                defaultValue={selectedPassenger.loyalty_status}
                options={[
