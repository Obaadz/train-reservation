    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="mb-6">
        <div className="bg-indigo-50 p-4 rounded-lg">
          ...
          <div className="text-2xl font-bold text-indigo-900">{totalAmount} SAR</div>
        </div>
      </div>
      ...
      >
        ...
        <p className="text-sm text-gray-500 text-center mt-4">{t("securePayment")}</p>

        {!formData?.selectedSeat && (
          <p className="text-red-500 text-center">{t("waitlistedMessage")}</p>
        )}
      </form>
    </div>
  );
